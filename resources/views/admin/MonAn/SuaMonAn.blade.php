                ...
                <div class="panel-body">
                    <form role="form" method="POST" action="" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" placeholder="Tên món ăn" name="TenMonAn" value="{{$MonAn->Ten_monan}}">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <select name="idDanhMuc" id="input" class="form-control"  >
                                    ...
                                    <option value="{{ $item->id}}" @if($item->id==$MonAn->idDanhMuc) selected @endif> {{$item->Ten_danhmuc}}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-md-4">
                        ...
                        <div class="form-group">
                            <label>Mô tả</label>
                            <textarea class="form-control" rows="3" name="MoTa">{{$MonAn->Mo_ta}} </textarea>
                        </div>
